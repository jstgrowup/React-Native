                ...
                renderItem={({ item }) => {
                    return (
                        <View style={styles.Viewstyle}>
                            <Text style={styles.textStyles}>{item.model}</Text>
                            <Text style={styles.textStyles}>{item.category}</Text>
                            <Text style={styles.textStyles} >{item.price}</Text>
                            {/* <Text style={styles.textStyles}>{item.img}</Text> */}
